...
WebUI.check(findTestObject('Page_TestDrive_Model_Overview/step4_inactive'))

WebUI.check(findTestObject('Page_TestDrive_Model_Overview/footer_co2'))

WebUI.click(findTestObject('Page_TestDrive_Model_Overview/modelsObjects_for_Model_Overview/modelOverview_C_class'))

WebUI.check(findTestObject('Page_TestDrive_Model_Overview/model_layer_objects/generic_dropdown_fueltype'))
